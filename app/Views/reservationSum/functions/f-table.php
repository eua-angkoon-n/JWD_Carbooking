...
switch($action){
    default:
        $DataTableCol = array( 
            ...
            5 => "tb_reservation.ref_id_driver",
            6 => "tb_reservation.traveling_companion",
            7 => "tb_coordinates.place_name",
            8 => "tb_reservation.accessories",
            9 => "tb_reservation.start_date",
            10 => "tb_reservation.id_reservation",
            11 => "tb_reservation.reservation_status",
            12 => "tb_reservation.id_reservation",
        );
    break;
}
