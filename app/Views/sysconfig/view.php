            ...
            <form id="configForm" class="addform" name="addform" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 col-md-4">
                            <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-9">
                                    <input type="number" class="form-control" id="reservation_t" name="reservation_t" placeholder="นาที" value="<?php echo $List->getReservation_t() ?>" aria-describedby="inputGroupPrepend" required>
                                </div>

                                  <div class="col-3 align-content-center"><h6 class="m-0 mt-1"><b>ชั่วโมง</b></h6></div>
                              </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-4">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-4">
                            <div class="form-group">
                                <label for="exampleInputEmail1">เวอร์ชันของระบบ:</label>
                              <div class="row">

                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                        <label for="reservation_t">Phase:</label>
                                        <input type="number" class="form-control w-100" id="sysPhase" name="sysPhase" placeholder="Phase" value="<?php echo $List->getPhase() ?>" aria-describedby="inputGroupPrepend" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control w-75" id="sysVersion" name="sysVersion" placeholder="Version" value="<?php echo $List->getVersion() ?>" aria-describedby="inputGroupPrepend" required>
                                    </div>
                                </div>
