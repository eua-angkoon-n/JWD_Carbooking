...
Class Type_Vehicle {
    ...
    public function __construct($frmData,$action) {
        ...
        !empty($output['id_vehicle_driver']) ? $this->isEdit = true : $this->isEdit = false;
        $this->type_status  = $output['type_status'];
        $this->vehicle_type = $output['vehicle_driver'];
        $this->id_row       = $output['id_vehicle_driver'];
        $this->action       = $action;
    }
    ...
    public function DoAddData(){
        ...
        try {
            ...
            $result = $obj->addRow($value, "tb_driver");
            return $result;
    ...
    public function DoEditData() {
        ...
        try {
            ...
            $result = $obj->update($value, 'id_driver='.$this->id_row, "tb_driver");
            return $result;
        } catch (PDOException $e) {
            return "Database connection failed: " . $e->getMessage();
    ...
    public function chkName($vehicle_type, $mode){
        $sql  = "SELECT id_driver ";
        $sql .= "FROM `tb_driver` ";
        $sql .= "WHERE driver_name = '$vehicle_type' ";
        if($mode == 'edit'){
            $id_row = $this->id_row;
            $sql .= "AND id_driver <> $id_row ";
        }
...
Class Update_Status {
    ...
    public function DoUpdate(){
        $value =[
            'driver_status' => $this->chk_box_value,
        ];
...
Class Edit_Type {
    ...
    public function DoGetData(){
        ...
        try {
            ...
            $result = $obj->customSelect("SELECT * FROM tb_driver WHERE id_driver=$id_row;");
            return $result;
        } catch (PDOException $e) {
            return "Database connection failed: " . $e->getMessage();
