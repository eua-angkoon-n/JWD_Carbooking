...
Class DataTable extends TableProcessing {
    ...
    public function Div($id, $checked, $div){
        ...
        if($div == 'status'){
            ...
            $result .= "<a class='dropdown-item edit-vehicle_type' data-id='$id' data-toggle='modal' data-target='#modal-vehicle_type' data-backdrop='static' data-keyboard='false' title='แก้ไขข้อมูล'>";
