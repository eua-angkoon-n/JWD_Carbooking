...
Class Type_Vehicle {
    ...
    public function __construct($frmData,$action) {
        ...
        !empty($output['id_vehicle_type']) ? $this->isEdit = true : $this->isEdit = false;
        $this->type_status  = $output['type_status'];
        $this->vehicle_type = $output['vehicle_type'];
        $this->id_row       = $output['id_vehicle_type'];
        $this->action       = $action;
    }
    ...
    public function DoAddData(){
        ...
        try {
            ...
            $result = $obj->addRow($value, "tb_vehicle_type");
            return $result;
    ...
    public function DoEditData() {
        ...
        try {
            ...
            $result = $obj->update($value, 'id_vehicle_type='.$this->id_row, "tb_vehicle_type");
            return $result;
        } catch (PDOException $e) {
            return "Database connection failed: " . $e->getMessage();
    ...
    public function chkName($vehicle_type, $mode){
        $sql  = "SELECT id_vehicle_type ";
        $sql .= "FROM `tb_vehicle_type` ";
        $sql .= "WHERE vehicle_type = '$vehicle_type' ";
        if($mode == 'edit'){
            $id_row = $this->id_row;
            $sql .= "AND id_vehicle_type <> $id_row ";
        }
...
Class Update_Status {
    ...
    public function DoUpdate(){
        $value =[
            'type_status' => $this->chk_box_value,
        ];
...
Class Edit_Type {
    ...
    public function DoGetData(){
        ...
        try {
            ...
            $result = $obj->customSelect("SELECT * FROM tb_vehicle_type WHERE `tb_vehicle_type`.id_vehicle_type=$id_row;");
            return $result;
        } catch (PDOException $e) {
            return "Database connection failed: " . $e->getMessage();
