...
Class Type_Vehicle {
    ...
    public function __construct($frmData,$action) {
        ...
        !empty($output['id_expense']) ? $this->isEdit = true : $this->isEdit = false;
        $this->type_status  = $output['type_status'];
        $this->vehicle_type = $output['expense_name'];
        $this->id_row       = $output['id_expense'];
        $this->action       = $action;
    }
    ...
    public function DoAddData(){
        ...
        $value = [
            'expense_name' => $vehicle_type,
            'expense_status'  => $type_status,
        ...
        try {
            ...
            $result = $obj->addRow($value, "tb_expense");
            return $result;
    ...
    public function DoEditData() {
        ...
        try {
            ...
            $result = $obj->update($value, 'id_expense='.$this->id_row, "tb_expense");
            return $result;
        } catch (PDOException $e) {
            return "Database connection failed: " . $e->getMessage();
    ...
    public function chkName($vehicle_type, $mode){
        $sql  = "SELECT id_expense ";
        $sql .= "FROM `tb_expense` ";
        $sql .= "WHERE expense_name = '$vehicle_type' ";
        if($mode == 'edit'){
            $id_row = $this->id_row;
            $sql .= "AND id_expense <> $id_row ";
        }
...
Class Update_Status {
    ...
    public function DoUpdate(){
        $value =[
            'expense_status' => $this->chk_box_value,
        ];
...
Class Edit_Type {
    ...
    public function DoGetData(){
        ...
        try {
            ...
            $result = $obj->customSelect("SELECT * FROM tb_expense WHERE id_expense=$id_row;");
            return $result;
        } catch (PDOException $e) {
            return "Database connection failed: " . $e->getMessage();
